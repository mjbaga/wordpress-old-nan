...
class Post
{
    ...
    */
    ...
    {
        $this->slug = 'nan-resources';
        $this->label = __( 'Resources' );
    ...
    */
    ...
    function register_fields() 
    {
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5a8163e93ca7a',
            'title' => 'Resources',
            'fields' => array(
                array(
                    'key' => 'field_5a8163e9437e0',
                    'label' => 'Category',
                    'name' => 'category',
                    'type' => 'post_object',
                    'instructions' => '',
