...
class Post
{
    ...
    */
    ...
    {
        $this->slug = 'nan-stories';
        $this->label = __( 'Stories' );
    ...
    */
    ...
    function register_fields() 
    {
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5a816443b4100',
            'title' => 'Stories',
            'fields' => array(
                array(
                    'key' => 'field_5a816443ba695',
                    'label' => 'Category',
                    'name' => 'category',
                    'type' => 'post_object',
                    'instructions' => '',
